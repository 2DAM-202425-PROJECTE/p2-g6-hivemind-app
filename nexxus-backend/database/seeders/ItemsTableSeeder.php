...
class ItemsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $items = [
            ...
            ['id' => 43, 'name' => 'Rainbow', 'price' => 400, 'iconUrl' => 'https://api.iconify.design/lucide/palette.svg'],
            ['id' => 44, 'name' => 'Glitter', 'price' => 450, 'iconUrl' => 'https://api.iconify.design/lucide/sparkles.svg'],
            ['id' => 45, 'name' => 'Shadow', 'price' => 350, 'iconUrl' => 'https://api.iconify.design/lucide/box.svg'],
            ['id' => 46, 'name' => 'Pixel', 'price' => 400, 'iconUrl' => 'https://api.iconify.design/lucide/square.svg'],
            ['id' => 47, 'name' => 'Cosmic', 'price' => 500, 'iconUrl' => 'https://api.iconify.design/lucide/stars.svg'],
            ['id' => 48, 'name' => 'Golden Frame', 'price' => 300, 'iconUrl' => 'https://api.iconify.design/lucide/square.svg'],
            ['id' => 49, 'name' => 'Crystal Frame', 'price' => 350, 'iconUrl' => 'https://api.iconify.design/lucide/pentagon.svg'],
            ['id' => 50, 'name' => 'Flame Frame', 'price' => 400, 'iconUrl' => 'https://api.iconify.design/lucide/flame.svg'],
            ['id' => 51, 'name' => 'Nature Frame', 'price' => 300, 'iconUrl' => 'https://api.iconify.design/lucide/flower.svg'],
            ['id' => 52, 'name' => 'Tech Frame', 'price' => 350, 'iconUrl' => 'https://api.iconify.design/lucide/cpu.svg'],
            ['id' => 53, 'name' => 'Star Frame', 'price' => 400, 'iconUrl' => 'https://api.iconify.design/lucide/star.svg'],
            ['id' => 54, 'name' => 'Cloud Frame', 'price' => 300, 'iconUrl' => 'https://api.iconify.design/lucide/cloud.svg'],
            ['id' => 55, 'name' => 'Royal Frame', 'price' => 450, 'iconUrl' => 'https://api.iconify.design/lucide/crown.svg'],
